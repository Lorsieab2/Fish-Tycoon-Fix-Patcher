...
def verify(exe: Path, manifest_path: Path, enabled: set[str] | None = None) -> dict[str, object]:
    ...
    if "universal_supply_slots" in selected:
        ...
        checks.update({
            ...
            "alternate_slot_original_ret8_reclaims_inner_arguments": payload[labels["use_after_original"]] == 0xE8,
            "alternate_slot_ret8_preserved": payload[labels["use_swapped_epilogue"]:labels["use_swapped_epilogue"] + 7] == bytes.fromhex("5D 5F 5E 5B C2 08 00"),
            ...
            "common_egg_stack_hook": rel32_target(0x004213A7, data[0x213A7:0x213AC], 0xE8) == egg_target and rel32_target(0x004213AC, data[0x213AC:0x213B1], 0xE9) == 0x004213D1,
            "unusual_egg_stack_hook": rel32_target(0x00421476, data[0x21476:0x2147B], 0xE8) == egg_target and rel32_target(0x0042147B, data[0x2147B:0x21480], 0xE9) == 0x004214A0,
            "rare_egg_stack_hook": rel32_target(0x00421549, data[0x21549:0x2154E], 0xE8) == egg_target and rel32_target(0x0042154E, data[0x2154E:0x21553], 0xE9) == 0x00421573,
